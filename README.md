...
[![CI](https://github.com/anagri/my-test-app/actions/workflows/ci.yml/badge.svg)](https://github.com/anagri/my-test-app/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Deploy](https://github.com/anagri/my-test-app/actions/workflows/deploy-pages.yml/badge.svg)](https://github.com/anagri/my-test-app/actions/workflows/deploy-pages.yml)

🚀 **[Live Demo](https://anagri.github.io/my-test-app/)**
...
git clone https://github.com/anagri/my-test-app.git
cd my-test-app
...
Visit `http://localhost:5173/my-test-app/` to view the app.
...
**Via CLI:**
```bash
gh api -X POST "/repos/anagri/my-test-app/pages" -f build_type=workflow
```
...
The app is deployed to: `https://anagri.github.io/my-test-app/`
